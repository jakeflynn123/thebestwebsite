        ...
        <section class="container">
            <div class="row">
                ...
                <?php include "errors.php"; ?>
                    ...
                    <input id="password" name="password_1" type="text" class="form-control" placeholder="Password" required>
                    <label for="inputPassword2" class="sr-only">Confirm Password</label>
                    <input name="password_2" type="text" class="form-control" placeholder="Password" required>
